    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                <button class="btn btn-primary btn-sm" onclick="showFormModal('Add New District','Save')">
        ...
        if (id) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#store_or_update_form #division_id').val(data.division_id);

                var division_id = data.division_id;

                    // Set the selected option in the select box
                $("#division_id option").each(function() {
                    if ($(this).val() == division_id) {
